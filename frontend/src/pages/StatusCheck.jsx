  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div className="flex gap-3 mb-4">
        <input
          type="text"
          placeholder="Enter Order ID or Collect ID"
        ...
        <div className="p-4 border rounded shadow bg-gray-50">
          {result.error ? (
            ...
            <>
              ...
              <p><b>Order ID:</b> {result.custom_order_id}</p>
              <p><b>Collect ID:</b> {result.collect_id}</p>
              <p><b>School:</b> {result.school_id}</p>
              <p><b>Gateway:</b> {result.gateway}</p>
              <p><b>Amount:</b> ₹{result.transaction_amount}</p>
            </>
          )}
        </div>
      )}
